...
<body>
    ...
    <form  method="POST">
     ...
     <input type="text" name="nom" placeholder="son nom" value=" <?=$edit_chats['nom'] ?>" ><br>
     <input type="text" name="categorie" placeholder=" sa categorie " value="<?= $edit_chats['categorie']?>"><br>
     <textarea name="info" placeholder="ses information"  > <?=$edit_chats['info']?> </textarea> <br>
